...
import { MatLegacyDialog as MatDialog, MatLegacyDialogContent as MatDialogContent, MatLegacyDialogModule as MatDialogModule, MAT_LEGACY_DIALOG_DATA as MAT_DIALOG_DATA } from '@angular/material/legacy-dialog';
