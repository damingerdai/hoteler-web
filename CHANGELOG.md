...
- chore: remove isDevMode ([0da2d20](https://github.com/damingerdai/hoteler-web/commit/0da2d20))
- chore: set release version commit message template ([f6abf63](https://github.com/damingerdai/hoteler-web/commit/f6abf63))
- chore: update angular schematics configuration and format ([101603c](https://github.com/damingerdai/hoteler-web/commit/101603c))
- chore: update build docker shell scripts ([2266380](https://github.com/damingerdai/hoteler-web/commit/2266380))
- chore: update dependencies library to support angular 21 ([991845d](https://github.com/damingerdai/hoteler-web/commit/991845d))
- chore(deps): update actions/checkout action to v5 (#1460) ([0ea052d](https://github.com/damingerdai/hoteler-web/commit/0ea052d)), closes [#1460](https://github.com/damingerdai/hoteler-web/issues/1460)
- chore(deps): update actions/setup-node action to v5 (#1461) ([6abfe5f](https://github.com/damingerdai/hoteler-web/commit/6abfe5f)), closes [#1461](https://github.com/damingerdai/hoteler-web/issues/1461)
- chore(deps): update angular-cli monorepo to v20.3.3 (#1455) ([f050b26](https://github.com/damingerdai/hoteler-web/commit/f050b26)), closes [#1455](https://github.com/damingerdai/hoteler-web/issues/1455)
- chore(deps): update appleboy/ssh-action action to v1.2.5 (#1466) ([42851c3](https://github.com/damingerdai/hoteler-web/commit/42851c3)), closes [#1466](https://github.com/damingerdai/hoteler-web/issues/1466)
- chore(deps): update nginx docker tag to v1.29.2 (#1458) ([daeaaf9](https://github.com/damingerdai/hoteler-web/commit/daeaaf9)), closes [#1458](https://github.com/damingerdai/hoteler-web/issues/1458)
- chore(deps): update nginx docker tag to v1.29.8 (#1468) ([38325ff](https://github.com/damingerdai/hoteler-web/commit/38325ff)), closes [#1468](https://github.com/damingerdai/hoteler-web/issues/1468)
- chore(deps): update node.js to v22.20.0 (#1459) ([45af910](https://github.com/damingerdai/hoteler-web/commit/45af910)), closes [#1459](https://github.com/damingerdai/hoteler-web/issues/1459)
- chore(deps): update rust crate serde to v1.0.228 (#1464) ([3b41b1a](https://github.com/damingerdai/hoteler-web/commit/3b41b1a)), closes [#1464](https://github.com/damingerdai/hoteler-web/issues/1464)
- feat: bump ngx-apexcharts from 0.8.4 to 0.9.0 ([0b2c2ca](https://github.com/damingerdai/hoteler-web/commit/0b2c2ca))
- feat: bump angular eslint to v20.3 ([240eee1](https://github.com/damingerdai/hoteler-web/commit/240eee1))
- feat: bump angular eslint to v21.0 ([66b9155](https://github.com/damingerdai/hoteler-web/commit/66b9155))
- feat: bump angular to 21.1.3 ([9952421](https://github.com/damingerdai/hoteler-web/commit/9952421))
- feat: bump angular to v20.3 ([55bf670](https://github.com/damingerdai/hoteler-web/commit/55bf670))
- feat: bump angular v21 ([1d131aa](https://github.com/damingerdai/hoteler-web/commit/1d131aa))
- feat: bump ngx-apexcharts from 0.8.3 -> 0.8.4 ([840ef3e](https://github.com/damingerdai/hoteler-web/commit/840ef3e))
- feat: design a new Material 3 customer card component and optimize customer list layouts ([a506538](https://github.com/damingerdai/hoteler-web/commit/a506538))
- feat: design a new Material 3 room card component and optimize room list layouts ([5a0a7eb](https://github.com/damingerdai/hoteler-web/commit/5a0a7eb))
- feat: drawer迁移到m3的设计 ([cd47090](https://github.com/damingerdai/hoteler-web/commit/cd47090))
- feat: navbar使用m3的设计 ([42a0234](https://github.com/damingerdai/hoteler-web/commit/42a0234))
- feat: profile 菜单支持m3的设计 ([5529afd](https://github.com/damingerdai/hoteler-web/commit/5529afd))
- feat: toggle theme button support m3 ([2e4942f](https://github.com/damingerdai/hoteler-web/commit/2e4942f))
- feat: 使用全新的dark mode切换模式 ([f16c4c7](https://github.com/damingerdai/hoteler-web/commit/f16c4c7))
- feat: 更新暂无客户数据的样式 ([148cdf6](https://github.com/damingerdai/hoteler-web/commit/148cdf6))
- feat: 更新暂无房间数据的样式 ([e816076](https://github.com/damingerdai/hoteler-web/commit/e816076))
- feat: 订单管理页面迁移到m3设计 ([05c2aa3](https://github.com/damingerdai/hoteler-web/commit/05c2aa3))
- feat: 重新设计注册页面 ([9bce963](https://github.com/damingerdai/hoteler-web/commit/9bce963))
- feat: 重新设计登录页面 ([c0dad60](https://github.com/damingerdai/hoteler-web/commit/c0dad60))
- fix: add content class and apply top padding ([2f86fed](https://github.com/damingerdai/hoteler-web/commit/2f86fed))
- fix: fix register crash and navigation issue ([d80f52c](https://github.com/damingerdai/hoteler-web/commit/d80f52c))
- fix: sort user role ([c72d732](https://github.com/damingerdai/hoteler-web/commit/c72d732))
- fix: 修复头像中字体过小的问题 ([342d9a4](https://github.com/damingerdai/hoteler-web/commit/342d9a4))
- refactor: remove PWA support and service worker integration (#1478) ([99675dc](https://github.com/damingerdai/hoteler-web/commit/99675dc)), closes [#1478](https://github.com/damingerdai/hoteler-web/issues/1478)
- refactor: update long-shadow function to use @if/@else syntax ([75b6168](https://github.com/damingerdai/hoteler-web/commit/75b6168))
- refactor: use class instead of ngClass ([84cd443](https://github.com/damingerdai/hoteler-web/commit/84cd443))
- refactor: use style instead of ngStyle ([03dad77](https://github.com/damingerdai/hoteler-web/commit/03dad77))
- refactor: 用户管理列表页面全新更新 ([95c843d](https://github.com/damingerdai/hoteler-web/commit/95c843d))
- refactor: 重新设计dashboard的页面 ([292f445](https://github.com/damingerdai/hoteler-web/commit/292f445))
- refactor: 重构创建用户的dialog ([9a509f9](https://github.com/damingerdai/hoteler-web/commit/9a509f9))
- refactor: 重构更新user的dialog ([99b5007](https://github.com/damingerdai/hoteler-web/commit/99b5007))
...
- test: PageHeaderComponent在单元测试的时候不要detectChanges ([c3fa844](https://github.com/damingerdai/hoteler-web/commit/c3fa844))
- test: remove SkeletonLoaderComponent and ButtonLoadingDirective的测试 ([e53fa60](https://github.com/damingerdai/hoteler-web/commit/e53fa60))
